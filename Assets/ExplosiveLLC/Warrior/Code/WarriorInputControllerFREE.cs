...
namespace WarriorAnimsFREE
{
    public class WarriorInputControllerFREE : MonoBehaviour
    {
        ...
        private void InputsJoystick()
        {
            inputHorizontal = playerMover.Move.x;
            inputVertical = playerMover.Move.y;
            inputAttack0 = playerMover.Attack;
            inputJump = playerMover.Jump;
        }
